...
Namespace CollapsiblePanel
    ...
    Public Class CollapseGroupBox  
        Inherits UserControl

        Private Dim     components              As  Container  

        Private Dim     boolResizeFromCollapse  As  Boolean    
	    Private Dim     strCaption              As  String
        ' size of panel when opened to full size
	    Private Dim     fullSize                As  Size = Size

        ' collapse box in upper left corner
		Public  Dim     collapseBox             As  CollapseBox
		...
		Private Sub CollapseGroupBox_Resize(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            If boolResizeFromCollapse <> True 
				fullSize = Size
			End If
